...
public class LoadDbAsyncTask extends AsyncTask<Integer, Long, List<NotiData>> {
    ...
    public LoadDbAsyncTask(Activity activity, RecyclerView recyclerView, List<NotiData> notiData) {
